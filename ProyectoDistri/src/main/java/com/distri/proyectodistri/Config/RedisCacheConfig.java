package com.distri.proyectodistri.Config;
...
public class RedisCacheConfig {
    @Value("${cache.ttl.compras:15}") private long ttlComprasMin;
    ...
    public CacheManager cacheManager(RedisConnectionFactory cf,
        ...
        cfgs.put("compras", defaultCfg.entryTtl(Duration.ofMinutes(ttlComprasMin)));
