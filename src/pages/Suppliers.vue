    ...
    <section class="card">
        ...
        <div class="card-body">
            ...
            <div class="pager" v-if="totalPages > 1">
                ...
                <button class="btn" :disabled="page === 0 || loading" @click="prev">
                    Anterior
                </button>
                <span>
                    Página {{ page + 1 }} de {{ totalPages }} ({{ totalElements }} total)
                </span>
                <button class="btn" :disabled="page >= totalPages - 1 || loading" @click="next">
                    Siguiente
                </button>
                <button class="btn" :disabled="page >= totalPages - 1 || loading" @click="goLast">
                    »
                </button>
            </div>
        </div>
...
// Usamos la misma base que en el resto de la app
const API_BASE =
