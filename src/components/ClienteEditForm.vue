<template>
    <div class="modal" @keydown.esc="onClose" v-if="cliente">
        ...
        <div class="card modal-card" role="dialog" aria-modal="true">
            ...
            <div class="card-body">
                <form @submit.prevent="onSubmit" class="form">
                    <div class="grid">
                        <label class="input">
                            <input v-model.trim="form.nombre" placeholder="Nombre *" :class="{ invalid: errors.nombre }"
                                autocomplete="off" />
                        </label>
                        ...
                        <label class="input">
                            <input v-model.trim="form.correo" placeholder="Correo electrónico" autocomplete="off"
