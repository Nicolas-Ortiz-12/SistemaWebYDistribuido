...
import com.distri.proyectoVenta.apis.mapper.CategoriaMapper;
import com.distri.proyectoVenta.apis.repository.CategoriaRepository;
...
public class CategoriaService {
    ...
    @Transactional(readOnly = true)
    @Cacheable(value = "sd", key = "'api_categoria_' + #id")
    ...
    @Transactional
    @CachePut(value = "sd", key = "'api_categoria_' + #result.id", unless = "#result == null")
    ...
    @Transactional
    @CacheEvict(value = "sd", key = "'api_categoria_' + #id")
